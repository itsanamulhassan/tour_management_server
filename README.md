...
| **POST** | `/api/v1/auths/reset_password`       | Reset password after verification *(Requires authorization)*               |
| **POST** | `/api/v1/auths/change_password`      | Change password for logged-in user *(Requires authorization)*              |
| **POST** | `/api/v1/auths/set_password`         | Set a new password for a newly verified account *(Requires authorization)* |
