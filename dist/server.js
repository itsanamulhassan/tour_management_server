...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield mongoose_1.default.connect("mongodb+srv://tuhinphotos0:uan7yBr8NCuZ6jRq@freecluster.zfjeifc.mongodb.net/tour-management-system?retryWrites=true&w=majority&appName=FreeCluster");
        console.log("✅ Server has been connected successfully with Database");
        server = app_1.default.listen(5000, () => console.log("Server has been connected with the port of 5000"));
    }
    catch (error) {
        console.error(error);
    }
